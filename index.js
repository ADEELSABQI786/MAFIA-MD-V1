...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there MAFIA-MD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet MAFIA-MD WhatsApp Bot.\n\n *Thanks for using MAFIA-MD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029VakJs4YJkK7BYQF1Wp1g = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/ADEELSABQI786/MAFIA-MD-V1\n\n> © Powered BY ᴍᴀꜰɪᴀ ᴀᴅᴇᴇʟ \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://qu.ax/XWtbY.jpg` }, caption: up })
  }
  })
  ...
  if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_STATUS_REACT === "true"){
    const ADEELlike = await conn.decodeJid(conn.user.id);
    const emojis = ['❤️', '💸', '😇', '🍂', '💥', '💯', '🔥', '💫', '💎', '💗', '🤍', '🖤', '👀', '🙌', '🙆', '🚩', '🥰', '💐', '😎', '🤎', '✅', '🫀', '🧡', '😁', '😄', '🌸', '🕊️', '🌷', '⛅', '🌟', '🗿', '🇵🇰', '💜', '💙', '🌝', '🖤', '💚'];
    ...
    }, { statusJidList: [mek.key.participant, ADEELlike] });
  }                       
  ...
  const udp = botNumber.split('@')[0];
    const ADEEL = '923131613251';
    let isCreator = [udp, ADEEL, config.DEV]
