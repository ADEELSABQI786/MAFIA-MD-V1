...
cmd({  
  ...
  try {  
    ...
    const { data: commitData } = await axios.get("https://api.github.com/repos/ADEELSABQI786/MAFIA-MD-V1/commits/main");  
    ...
    await reply("```MAFIA-MD Bot Updating...🚀```\n");  
      
    // Download latest code  
    const zipPath = path.join(__dirname, "latest.zip");  
    const { data: zipData } = await axios.get("https://github.com/ADEELSABQI786/MAFIA-MD-V1/archive/main.zip", { responseType: "arraybuffer" });  
