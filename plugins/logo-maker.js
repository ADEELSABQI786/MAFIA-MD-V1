...
cmd({
  ...
  try {
    ...
    let responseText = `*🤍 MAFIA-MD LOGO MAKER 💫*\n\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n`
    + `*◈ Text:* ${q}\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n\n`
    ...
    conn.ev.on('messages.upsert', async (event) => {
      ...
      if (receivedMessage.message.extendedTextMessage.contextInfo && 
        ...
        if (logoUrls[receivedText]) {
          ...
          await conn.sendMessage(from, { image: { url: response.result.download_url }, caption: "> *© Powered By ᴍᴀꜰɪᴀ-ᴀᴅᴇᴇʟ*" }, { quoted });
        } else {
